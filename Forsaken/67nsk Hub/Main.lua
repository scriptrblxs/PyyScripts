    ...
    hum.Running:Connect(function(spd)
        ...
        if spd > 0.01 then
            if sprinting then
                playAnimation(
                    hum,
                    AnimationIds.Run[SelectedAnimations.Run] or AnimationIds.Run.Survivor,
                    10,
                    spd / 26
                )
            else
                playAnimation(
                    hum,
                    AnimationIds.Walk[SelectedAnimations.Walk] or AnimationIds.Walk.Survivor,
                    10,
                    spd / 12
                )
            end
            ...
            playAnimation(
                hum,
                AnimationIds.Idle[SelectedAnimations.Idle] or AnimationIds.Idle.Survivor,
                9,
                1
            )
        end
